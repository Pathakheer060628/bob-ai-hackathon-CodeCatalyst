...
export default function EnergyFlowDiagram({ hour, socPct }) {
  ...
  const shedding = data.shed_mw > 0.01;
  ...
  return (
    <div className={`energy-flow ${live ? "" : "energy-flow--demo"}`}>
      <svg className="energy-flow__lines" viewBox="0 0 100 100" preserveAspectRatio="none" aria-hidden="true">
        <defs>
          <marker id="ef-arrow-sun" viewBox="0 0 8 8" refX="6" refY="4" markerWidth="4.5" markerHeight="4.5" orient="auto-start-reverse">
            <path d="M0,0 L8,4 L0,8 Z" style={{ fill: "var(--series-2)" }} />
          </marker>
          <marker id="ef-arrow-battery" viewBox="0 0 8 8" refX="6" refY="4" markerWidth="4.5" markerHeight="4.5" orient="auto-start-reverse">
            <path d="M0,0 L8,4 L0,8 Z" style={{ fill: "var(--accent)" }} />
          </marker>
          <marker id="ef-arrow-home" viewBox="0 0 8 8" refX="6" refY="4" markerWidth="4.5" markerHeight="4.5" orient="auto-start-reverse">
            <path d="M0,0 L8,4 L0,8 Z" style={{ fill: "var(--series-1)" }} />
          </marker>
          <marker id="ef-arrow-grid" viewBox="0 0 8 8" refX="6" refY="4" markerWidth="4.5" markerHeight="4.5" orient="auto-start-reverse">
            <path d="M0,0 L8,4 L0,8 Z" style={{ fill: spilling ? "var(--status-critical)" : "var(--status-good)" }} />
          </marker>
        </defs>
        <path className="energy-flow__path energy-flow__path--sun" d="M50,15 L50,25" markerEnd="url(#ef-arrow-sun)" />
        <path className="energy-flow__path energy-flow__path--panel" d="M50,37 L50,47" markerEnd="url(#ef-arrow-sun)" />
        <path className="energy-flow__path energy-flow__path--battery" d="M50,59 C50,68 18,68 18,75" markerEnd="url(#ef-arrow-battery)" />
        <path className="energy-flow__path energy-flow__path--home" d="M50,59 L50,75" markerEnd="url(#ef-arrow-home)" />
        <path
          className={`energy-flow__path energy-flow__path--grid ${spilling ? "energy-flow__path--spill" : ""}`}
          d="M50,59 C50,68 82,68 82,75"
          markerEnd="url(#ef-arrow-grid)"
        />
      </svg>
      ...
      <div className="energy-flow__node energy-flow__node--panels">
        <div className="energy-flow__chip">
      ...
      <div className="energy-flow__node energy-flow__node--inverter">
        ...
        <span className="energy-flow__inverter-caption">Inverter</span>
      </div>
      ...
      <div className="energy-flow__outputs">
        <div className={`energy-flow__node energy-flow__node--battery ${charging ? "is-charging" : ""} ${discharging ? "is-discharging" : ""}`}>
          <div className="energy-flow__chip">
            ...
            <span className="energy-flow__label">
              Battery
              {charging && <span className="energy-flow__flow-tag energy-flow__flow-tag--charge">charging</span>}
              {discharging && <span className="energy-flow__flow-tag energy-flow__flow-tag--discharge">discharging</span>}
            </span>
        ...
        <div className="energy-flow__node energy-flow__node--home">
          <div className="energy-flow__chip">
            ...
            <span className="energy-flow__label">
              Home / demand
              {shedding && <span className="energy-flow__flow-tag energy-flow__flow-tag--shed">−{fmt(data.shed_mw)} MW shed</span>}
            </span>
        ...
        <div className="energy-flow__node energy-flow__node--grid">
          <div className="energy-flow__chip">
            ...
            <span className="energy-flow__label">
              Grid
              {spilling && <span className="energy-flow__flow-tag energy-flow__flow-tag--spill">{fmt(data.curtail_mw)} MW curtailed</span>}
            </span>
